...
@NamedQueries({
    ...
    @NamedQuery(name = "PeminjamanSkripsi.findByJumlahSkripsi", query = "SELECT p FROM PeminjamanSkripsi p WHERE p.jumlahSkripsi = :jumlahSkripsi"),
...
public class PeminjamanSkripsi implements Serializable {
    ...
    public PeminjamanSkripsi(String id) {
        this.id = id;
    }
    ...
    public String toString() {
        return "pbo_uas.PeminjamanSkripsi[ id=" + id + " ]";
    }
